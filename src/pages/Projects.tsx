  ...
  const projects = [
    {
      title: "Tune-Port",
      description:
        "A personalized Spotify experience for users with customized recommendations, in-depth listening habit analysis, and playlist creation tools. Wrapped Portal allows users to discover new music that aligns with their unique tastes and maximize their musical journey.",
      date: "Feb-Mar 2023",
    ...
    },
    {
      title: "Prodigy-Path",
      description:
        "A mentorship platform that connects individuals for skills building and support with a search function, messaging, and contact sharing.",
